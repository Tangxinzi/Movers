  ...
  render() {
    ...
    return (
      <View style={styles.iconsBottomContainer}>
        <TouchableHighlight style={styles.iconsBottom} underlayColor="none" activeOpacity={0.85} onPress={() => this.props.navigation.push('RootContainerApp')}>
          <>
        ...
        <TouchableHighlight style={styles.iconsBottom} underlayColor="none" activeOpacity={0.85} onPress={() => this.props.navigation.popToTop('FolderScreen')}>
          <>
            <View style={styles.iconsContent}>
        ...
        <TouchableHighlight style={styles.iconsBottom, styles.iconsBottomHome} underlayColor="none" activeOpacity={0.85} onPress={() => this.props.navigation.popToTop('HomeScreen')}>
          <>
